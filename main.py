...
while juego_activo == True:
    ...
    if opcion == "1":
        ...
        if llave == True and tarjeta == True and codigo_descubierto == True:
            codigo = input("Ingresa el codigo de emergencia para abrir la puerta: ")
            if codigo == "314":
                print()
                print("La puerta comienza a abrirse lentamente...")
                print("Felicidades, has escapado del laboratorio secreto!")
                print("!!! FELICIDADES ¡¡¡")
                juego_activo = False
            else:
                print("Codigo incorrecto. La puerta permanece cerrada.")
        else:
            print("la puerta sigue bloqueada")
            print("Parece que necesitas encontrar mas objetos para poder abrirla.")

    elif opcion == "4":
        print()
        print("Has abandonado la mision.")
        juego_activo = False
    else:
        print()
